(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("vuedraggable"), require("element-ui"));
	else if(typeof define === 'function' && define.amd)
		define(["vuedraggable", "element-ui"], factory);
	else if(typeof exports === 'object')
		exports["lichFormCreator"] = factory(require("vuedraggable"), require("element-ui"));
	else
		root["lichFormCreator"] = factory(root["vuedraggable"], root["element-ui"]);
})((typeof self !== 'undefined' ? self : this), function(__WEBPACK_EXTERNAL_MODULE__289a__, __WEBPACK_EXTERNAL_MODULE__5f72__) {
...
"use strict";
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_commonPanel_vue_vue_type_style_index_0_id_78d18ef2_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("cb95");
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_commonPanel_vue_vue_type_style_index_0_id_78d18ef2_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_commonPanel_vue_vue_type_style_index_0_id_78d18ef2_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_commonPanel_vue_vue_type_style_index_0_id_78d18ef2_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
// NAMESPACE OBJECT: ./src/lib/global.js
var global_namespaceObject = {};
__webpack_require__.r(global_namespaceObject);
__webpack_require__.d(global_namespaceObject, "get", function() { return global_get; });
__webpack_require__.d(global_namespaceObject, "post", function() { return global_post; });
__webpack_require__.d(global_namespaceObject, "registerHttpService", function() { return global_registerHttpService; });
...
// CONCATENATED MODULE: ./src/components/creator/index.vue?vue&type=template&id=1ce13053&
...
var defaultElement_ComponentListService = /*#__PURE__*/function () {
  function ComponentListService() {
    _classCallCheck(this, ComponentListService);
  }

  _createClass(ComponentListService, null, [{
    key: "initService",

    /**注入一个新的组件 */
    value: function initService(type) {
      type.uuid = ComponentListService.createUUid(type, ComponentListService.collection.length);
      ComponentListService.collection.push(type);
    }
  }, {
    key: "createUUid",
    value: function createUUid(v, index) {
      return v.tag + "-" + index;
    }
  }]);
...
defaultElement_ComponentListService.collection = initComponentsConfig.map(function (v, index) {
  v.uuid = defaultElement_ComponentListService.createUUid(v, index);
  return v;
});
...
var basicComponentCollection = defaultElement_ComponentListService.collection.filter(function (v) {
  return v.type === EComponentType.basicComponent;
});
var formComponentCollection = defaultElement_ComponentListService.collection.filter(function (v) {
...
/**组件注册解析服务 */
var services_ComponentsPack = /*#__PURE__*/function () {
  function ComponentsPack() {
    _classCallCheck(this, ComponentsPack);

    this.components = {};
  }

  _createClass(ComponentsPack, [{
    key: "getService",
...
var services_ComponentsService = function ComponentsService(serviceName) {
...
var LTextView_LTextView = /*#__PURE__*/function (_ComponentsService) {
  _inherits(LTextView, _ComponentsService);
  ...
  _createClass(LTextView, [{
    ...
    value: function render(h, formConfig, formMap) {
      var value = formMap[formConfig.textModel] || formConfig.defaultValue;
      return h("div", {}, value);
    }
  }]);

  return LTextView;
}(services_ComponentsService);
...
var LELSelect_LElSelect = /*#__PURE__*/function (_ComponentsService) {
  _inherits(LElSelect, _ComponentsService);
...
var componentsPack = new services_ComponentsPack();
componentsPack.registerService(LTextView_LTextView);
componentsPack.registerService(LELSelect_LElSelect);
/* harmony default export */ var services = (componentsPack);
...
function loadMonaco(cb) {
  ...
  var vs = "/static/vendors/jsonDrawer"; // 使用element ui实现加载提示
  ...
  loadScriptQueue(["".concat(vs, "/editor/loader.js"), "".concat(vs, "/editor/editor.main.nls.js"), "".concat(vs, "/editor/editor.main.js"), "".concat(vs, "/language/json/jsonMode.js")], function () {
...
function loadBeautifier(cb) {
  ...
  JsonDrawer_loadScript("/static/vendors/jsonDrawer/beautifier/beautifier.min.js", function () {
    loading.close(); // eslint-disable-next-line no-undef
...
/* harmony default export */ var JsonDrawervue_type_script_lang_js_ = ({
  ...
  mounted: function mounted() {
    ...
    var clipboard = new clipboard_default.a(".copy-json-btn", {
      text: function text() {
        _this.$notify({
          title: "成功",
...
/* harmony default export */ var commonPanelvue_type_script_lang_js_ = ({
  ...
  data: function data() {
    return {
      formData: {},
      // controlId: null,
      controlList: defaultElement_ComponentListService.collection // updateValue: debounce(340, this.update.bind(this))
...
// EXTERNAL MODULE: ./src/components/creator/rightPanel/commonPanel.vue?vue&type=style&index=0&id=78d18ef2&lang=scss&scoped=true&
var commonPanelvue_type_style_index_0_id_78d18ef2_lang_scss_scoped_true_ = __webpack_require__("4c1b");
...
var commonPanel_component = normalizeComponent(
  ...
  commonPanelvue_type_template_id_78d18ef2_scoped_true_render,
  commonPanelvue_type_template_id_78d18ef2_scoped_true_staticRenderFns,
  false,
  null,
  "78d18ef2",
  null
...
var global_get = global_httpService.get;
var global_post = global_httpService.post; // 请求服务注册

var global_registerHttpService = function registerHttpService(_ref) {
  var get = _ref.get,
      post = _ref.post;
  if (get) global_httpService.get = get;
  if (post) global_httpService.post = post;
};
 ...
 * @Last Modified time: 2020-07-06 17:27:24
 */
    ...
    formApiValid: {
      ...
      handler: function handler(value) {
        ...
        this.submitConfig.apiValid.push.apply(this.submitConfig.apiValid, value.map(function (validApi) {
          return function () {
            return global_namespaceObject[validApi.type](validApi.name, _this.formMap);
          };
        }));
      }
    }
...
/* harmony default export */ var creatorvue_type_script_lang_js_ = ({
  ...
  data: function data() {
    return {
      ...
      formData: {},
      prevJson: null,
      drawingList: JSON.parse(JSON.stringify(defaultList)),
      leftComponents: [{
        title: "基础型组件",
        list: basicComponent
      }, {
...
var creator_component = normalizeComponent(
  ...
  creatorvue_type_template_id_1ce13053_render,
  staticRenderFns,
  false,
  null,
  null,
...
//# sourceMappingURL=lichFormCreator.umd.js.map